...
function DoctorRegisterComponent(props) {
    ...
    const registerHandler = (e) =>
    {
            ...
            {
                setIdError("Doctor ID required");
            }
            if(id.length>6)
            {
                iflag++;
                setIdError("Invalid Doctor ID");
            }
            if(password!=='')
            {
                ctr1++;
    ...
    return (
        <div>
            ...
            <br></br> <br></br> <br></br>
           <div class="row">
           <h3 style={{color:"coral",textAlign:"center"}}>Doctor Account Registration</h3>
               <div class="col-4"></div>
               <div class="col-4">
                   <br></br>
