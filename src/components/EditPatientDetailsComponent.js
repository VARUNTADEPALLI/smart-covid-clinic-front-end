...
function EditPatientDetailsComponent(props) {
...
const MedicalHistoryHandler = (e) =>
{
    ...
    const updateHandler = (e) =>
    {
            ...
            if(sum===0)
            {
                let error=0;
                let data ={
                    name,age,email,mobile,illness,illnessduration,medicalhistory,medicinesinuse
                };
                console.log(data);
                axios.put("http://localhost:9028/patient/updatePatientDetails/"+pid,data)
    ...
    {
        e.preventDefault();
        history('/Viewpatientprofile',{state:{pid}})
    }
    ...
    return (
        <div class="container">
            <br></br>
            <h1 style={{color:"sandybrown",textAlign:'center'}}>Edit Patient Details</h1>
            <br></br><br></br>
            <form style={{marginLeft:"200px"}}>
                <div class="row">
                    ...
                    <div class="col-10">
                        <div className='form-group'>
                            ...
                            <br></br>
                            <input type="text" name="name" id="name" placeholder='Enter Name' defaultValue={Userdetails.name} onChange={nameHandler} onBlur={nameHandler} class="form-control"></input>
                            <div style={{textAlign:"left"}}>
                ...
                <div class="col-5">
                    ...
                    <div style={{textAlign:"left"}}>
                            ...
                            <br></br>
                            <input type="text" name="age" id="age" defaultValue={Userdetails.age} placeholder='Enter age ' onChange={ageHandler}  onBlur={ageHandler} class="form-control"></input>
                            <div style={{textAlign:"left"}}>
                    ...
                    <div style={{textAlign:"left"}}>
                            ...
                            <br></br>
                            <input type="email" name="email" id="email" defaultValue={Userdetails.email} placeholder='Enter email' onChange={emailHandler}  onBlur={emailHandler} class="form-control"></input>
                            <div style={{textAlign:"left"}}>
                ...
                <div class="col-5">
                        <div className='form-group'>
                            ...
                            <br></br>
                            <input type="number" name="mobileNumber" id="mobileNumber" defaultValue={Userdetails.mobile} placeholder='Enter Phone number'onChange={phoneHandler}  onBlur={phoneHandler} class="form-control"></input>
                    ...
                    <div class="col-5">
                        <div className='form-group'>
                            ...
                            <br></br>
                            <input type="text" name="illness" id="illness" defaultValue={Userdetails.illness} placeholder='Enter illness'onChange={illnessHandler}  onBlur={illnessHandler} class="form-control"></input>
                ...
                <div class="col-5">
                    ...
                    <div style={{textAlign:"left"}}>
                            ...
                            <br></br>
                            <input type="text" name="illnessduration" id="illnessduration" defaultValue={Userdetails.illnessduration} placeholder='Enter illness duration'  onBlur={illnessdurationHandler} onChange={illnessdurationHandler} class="form-control"></input>
                            <div style={{textAlign:"left"}}>
                ...
                <div class="col-5">
                    ...
                    <div style={{textAlign:"left"}}>
                            ...
                            <br></br>
                            <input type="text" name="medicalhistory" id="medicalhistory" defaultValue={Userdetails.medicalhistory} placeholder='Enter medical history'  onBlur={MedicalHistoryHandler} onChange={MedicalHistoryHandler} class="form-control"></input>
                            <div style={{textAlign:"left"}}>
                ...
                <div class="col-5">
                        <div className='form-group'>
                            ...
                            <br></br>
                            <input type="text" name="medicinesinuse" id="medicinesinuse" defaultValue={Userdetails.medicinesinuse} placeholder='Enter medicines currently inuse'  onBlur={medicinesinuseHandler} onChange={medicinesinuseHandler} class="form-control"></input>
                ...
                <div class="col-2">
                <div style={{textAlign:""}}>
                            <button class="btn btn-info form-control"  onClick={backHandler} >Back</button> 
                        </div>
                </div>
                <div class="col-6"></div>
                <div class="col-2">
                        <div className='form-group'>
                            <button class="btn btn-warning form-control"  onClick={updateHandler} >Update</button> 
                        </div>
                    </div>
...
export default EditPatientDetailsComponent;